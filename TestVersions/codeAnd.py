...
while True:
    ...
    if switch and buttonReleased:
        if not lastButton:
            ...
            print("enable")
            keyboard.press(Keycode.26)
            keyboard.press(Keycode.27)
            keyboard.press(Keycode.43)
            time.sleep(0.15)
            keyboard.release(Keycode.26)
            keyboard.release(Keycode.27)
            keyboard.release(Keycode.43)
